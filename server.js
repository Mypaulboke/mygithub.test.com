...
const dom = new JSDOM('<!DOCTYPE html></html>', { url: 'http://47.104.238.163:8080' })
...
// article detail content http://47.104.238.163:8080/api/article?id=1496841740682
app.get('/api/article', router.getArticle)

// tags infomation
app.get('/api/tags', router.tags)

// get articles by tag http://47.104.238.163:8080/api/tag?tag=javascript
app.get('/api/tag', router.tag)

// search articles http://47.104.238.163:8080/api/search?q=js
app.get('/api/search', router.search)

// archives infomation
app.get('/api/archives', router.archives)

// get articles by archive http://47.104.238.163:8080/api/archive?date=201706
...
app.post('/api/user',router.user)

app.post('/api/account',router.account)
app.delete('/api/deleteAccount',hasToken,router.deleteAccount)
...
// delete article  http://47.104.238.163:8080/api/article?id=1496841740682
